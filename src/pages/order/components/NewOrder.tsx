            ...
            <div className="p-4 md:p-6">
                ...
                <div className="flex flex-wrap gap-2 justify-between md:flex-nowrap">
                    <div className="flex gap-2 w-full md:w-full justify-between">
                        ...
                        <button className="bg-red-500 text-white p-1 text-xs md:text-sm rounded font-normal hover:bg-red-600 transition w-full md:w-1/4">
                            Cancel Order
                        </button>
                        <button className="bg-green-500 text-white p-1 text-xs md:text-sm rounded font-normal hover:bg-green-600 transition w-full md:w-1/4">
                            Accept Order
                        </button>
                    </div>
                </div>
